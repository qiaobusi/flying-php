        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-default">
                    ...
                    <form class="form-horizontal" id="form" action="{{ url("manage/manager/save") }}">
                        <input name="id" type="hidden" id="id" value="{{ $manager->id }}">
                        <input name="_token" type="hidden" id="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="username" class="col-sm-2 control-label">用户名称</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="username" name="username" placeholder="用户名称" value="{{ $manager->username }}">
